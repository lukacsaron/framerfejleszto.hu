...
export function ProblemSolution() {
  ...
  return (
    <section className="ff-section dark ff-reveal" id="problem">
...
export function ProcessSection() {
  ...
  return (
    <section className="ff-section sunken ff-reveal" id="process">
      <div className="ff-container">
        <div className="ff-section-head">
          <div>
...
export function Benefits() {
  return (
    <section className="ff-section paper ff-reveal" id="benefits">
      <div className="ff-container">
        <div className="ff-section-head">
          <div>
        ...
        <div className="ff-benefits">
          {BENEFITS.map((b, i) => (
            <div className="ff-benefit" key={i}>
...
export function TrustSection() {
  return (
    <section className="ff-section sunken ff-reveal">
      <div className="ff-container">
...
export function Portfolio() {
  return (
    <section className="ff-section paper ff-reveal" id="works">
      <div className="ff-container">
        <div className="ff-section-head">
          <div>
          ...
          {PROJECTS.map(p => (
            <div className="pitem" key={p.title}>
              ...
              <div className="meta">
                ...
                <p>{p.body}</p>
                <div className="row">
                  <div className="stat">{p.stat}<sub>{p.statSub}</sub></div>
...
export function FAQSection() {
  ...
  return (
    <section className="ff-section paper ff-reveal" id="faq">
      <div className="ff-container">
