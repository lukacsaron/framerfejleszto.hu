...
export function FFLogoMark({ size = 28, className = '', ...rest }) {
  ...
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width={w} height={size} viewBox="0 0 248 124" fill="currentColor" {...rest}>
...
export function FFLogo({ onDark = false }) {
  return (
    <a href="#" className="ff-logo" aria-label="22.design – Főoldal" style={{ color: onDark ? '#fff' : 'var(--c-midnight-950)' }}>
      <FFLogoMark size={28} aria-hidden="true" />
    </a>
  );
}
