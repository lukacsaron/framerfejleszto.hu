...
**Badge-ek:**
- Framer Expert badge
- RGB PRO 2025 — Digital Design Award

**Kártyaváltó (Design / Live):**

A *Design* kártya egy Framer editor mockupot mutat; a *Live* kártya egy élő weboldal előnézetet az alábbi tartalommal:
...
**Cím:** Design → Handoff → Fejlesztés → Hiba → Újra

- ✕ 6–10 hét átfutás
- ✕ Kettős költség: design + kód
- ✕ Tartalommódosítás? Írj ticketet
- ✕ Pixel-eltérések, loop-ok
- ✕ Élesítés külön projekt

### A mi utunk · Framer (jobb oldal)

**Cím:** Design = Kód. Egy lépés.

- ✓ 3–7 nap élesítés
- ✓ Egyetlen számla, egyetlen csapat
- ✓ CMS: te is szerkeszted
- ✓ Pixel-pontos, 1:1
- ✓ One-click publish
...
**Eyebrow:** MIÉRT A FRAMER?

**Cím:**
> A FRAMER NEM CSAK GYORS. OKOS IS.

**Lead:** Miért pont ez a no-code platform? Négy konkrét ok, amiért a Framer más.

| Cím                              | Szöveg                                                                                                     |
| -------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| Tökéletes landing oldalakhoz.    | Villámgyors, reszponzív, látványos. Minden, amire egy kampány-microsite-nak szüksége van.                  |
| Te is tudod szerkeszteni.        | CMS-ben pár kattintás, nem kell minden apróságra ügynökséghez fordulni. Nincs „fejlesztői függőség".       |
| Fenntartható árazás.             | Nincs dupla költség design + fejlesztésre. Transzparens Framer előfizetés, havi díjjal.                    |
| SEO és villámgyors betöltés.     | Beépített SEO, global CDN, Lighthouse 90+. Nem kell plugint vadászni.                                     |

---

## 5. Csapat / Bizalom

**Eyebrow:** KIK ÁLLUNK MÖGÖTTE
...
**Cím:**
> NEM HIRDETJÜK MAGUNKAT. AZ ÜGYFELEINK IGEN.
...
**MENNYI IDŐ ALATT KÉSZÜL EL EGY OLDAL?**
Egy egyszerűbb landing page 3–5 munkanap. Teljes marketing microsite 5–10 munkanap. CMS-es, többoldalas site 2–3 hét. Mindezt beleértve a design fázist is.
...
**CTA gombok:**
- „Indítsuk el a projekted"
- „Nézd meg a munkáinkat"

**Lábszöveg:** ingyenes 30 perces konzultáció · nincs kötelezettség · budapesti csapat
...
### Brand oszlop
A 22.design no-code műhelye. Prémium weboldalak Framer-ben, senior csapattal, kompromisszumok nélkül.

Közösségi: Facebook · LinkedIn · Instagram
